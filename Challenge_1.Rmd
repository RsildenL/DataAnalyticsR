...
highest_avg_price_drink<-product_data[ type_drink_snack == 'drink' ,.(avg_price= mean(price)), 
                                       by = list(category, type_drink_snack)][avg_price == min(avg_price) | avg_price == max(avg_price)]
highest_avg_price_snack<-product_data[ type_drink_snack == 'snack' ,.(avg_price= mean(price)), 
                                       by = list(category, type_drink_snack)][avg_price == min(avg_price) | avg_price == max(avg_price)]

highest_category; highest_avg_price_category; highest_avg_price_snack; highest_avg_price_drink
```
