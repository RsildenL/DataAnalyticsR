...
```
Given the two options for locations, taking into account their respective factors, we would choose the first option because we predict higher sales for that location (10.16578 instead of 5.978487 in the daily sales variable), assuming that both locations cost us the same to acquire and maintain.
