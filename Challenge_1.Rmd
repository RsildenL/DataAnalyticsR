...
drink_dist <- drink_trend[ , .(daily_avg = mean(avg_daily)) , by=day]
drink_dist <- drink_dist %>% add_row(day = "Weekend", daily_avg =mean(drink_trend[day=="Sunday"|day=="Saturday"]$avg_daily)) 
drink_dist <- drink_dist %>% add_row(day = "Weekdays", daily_avg =mean(drink_trend[!(day=="Sunday"|day=="Saturday"),]$avg_daily))
drink_dist
```

```{r}
snack_trend[,day:=weekdays(date)]
snack_dist <- snack_trend[ , .(daily_avg = mean(avg_daily)) , by=day]
snack_dist <- snack_dist %>% add_row(day = "Weekend", daily_avg =mean(snack_trend[day=="Sunday"|day=="Saturday"]$avg_daily)) 
snack_dist <- snack_dist %>% add_row(day = "Weekdays", daily_avg =mean(snack_trend[!(day=="Sunday"|day=="Saturday"),]$avg_daily))
snack_dist
```
