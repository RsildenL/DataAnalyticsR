...
highest_avg_price_drink<-products[ type_drink_snack == 'drink' ,.(avg_price= mean(price)), by = list(category, type_drink_snack)][avg_price == min(avg_price) | avg_price == max(avg_price)]
