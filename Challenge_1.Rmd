...
The graph for drinks shows a general increase in daily_items across the available timeframe. To better illustrate this (linear) trend, we have created a new plot. The graph for snacks shows no such trend. Instead, the trendline of the new plot for snacks is a horizontal line. The reason for the increasing trend for drinks could be related to seasonal consumption habit. Rising temperatures might timulate the purchase of beverages without having an effect on the number of snack items sold. 
...
The vending machines are used more frequently on weekends than on the weekdays. A potential explanation for this could be that the people travel more on weekends as they have more time. Thus, vending machines, especially those in close proximity of public transport, might be more highly frequented on Saturdays and Sundays.
