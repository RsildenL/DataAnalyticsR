...
#Option 2  (Kevin): Standard interquartile range to eliminate outliers
q1 = quantile(machines$income_average, 0.25, na.rm = T)
q3 = quantile(machines$income_average, 0.75, na.rm = T)
int_quar_range = q3 - q1
machines[income_average > q1 - 1.5*int_quar_range & income_average < q3 + 1.5*int_quar_range]
