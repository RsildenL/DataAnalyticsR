...
```{r}
machine_na_to_zero <- machine_data[!is.na(machine_data$income_average), ]
dim(machine_na_to_zero)
```

Option 3: Substitute missing values with the mean income average 
```{r}
machine_data_replace_NA_mean <- machine_data[!is.na(machine_data$income_average), ] <- machine_data$income_average[machine_data$income_average==mean(machine_data$income_average)]
#machine_data$income_average[machine_data$income_average==mean(machine_data$income_average)]<-NA


```

Option 3: substitute missing values with average income of machine 
```{r}
machine_data_means <- machine_data[,.(mean(income_average)), by = .(machine)]
machine_data_means
income_NA$machine
machine_data$income_average[machine_data$income_average==mean(machine_data$income_average)]<-NA

machine_data$income_avg <- machine_data$income_average
```
