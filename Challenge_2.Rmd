...
Applying an EWS for high-risk alarms only we forecast an increase in profit of 2.37%. We recommend implementing the medium-risk EWS, as the average annual increase in revenue is 0.03% higher than for only high-risk alarms. This difference seems negligible, but in fact equates to $374,948 making the EWS for med-risk alarms the obvious choice from a business point of view.