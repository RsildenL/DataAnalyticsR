...
```
A last_vend variable, containing the timestamp of the previous sale of each machine, using the order and shift functions. 
...
#merged_data[, deltahours := difftime(merged_data$timestamp, merged_data$last_vend, units = "hours"), by=machine]
...
library(ggplot2) 
ggplot(train, aes(delta, failure)) +
