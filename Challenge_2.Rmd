...
print(paste('Average annual percentage increase in revenue for med-risk EWS: ', round(annual_perc_incr(dt_alarm_med, delta_med),4)))

## ii. And if we set the EWS only with the high-risk alarms?
print(paste('Average annual percentage increase in revenue for high-risk EWS: ', round(annual_perc_incr(dt_alarm_high, delta_high),4)))
```
